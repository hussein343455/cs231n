...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        Z=X.dot(W1)+b1# the output for the input layer
        X2 = np.maximum(0, Z)  # ReLU=actvation function for the hidden layer
        scores=X2.dot(W2)+b2#hidden layer(outbout) * weights that connect hidden to output
        ...
        dZ = dW1 * (Z>0)             # [NxH] . [NxH] = [NxH]
        dW1 = X.T.dot(dZ)              # [DxN] * [NxH] = [DxH]
